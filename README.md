AgenticDrone: Autonomous Multi-Modal Bridge Inspection Agent
AgenticDrone is a ROS 2-powered autonomous system designed for structural health monitoring and tactical surveillance. It utilizes Vision-Language Models (VLM) and YOLO to perform high-level reasoning on bridge integrity, detecting defects like cracks, spalling, and moisture ingress through multi-sensor fusion.
...
Bash
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/harsh/.local/lib/python3.10/site-packages/nvidia/
...
If using bitsandbytes with CUDA 13.x, you must ensure the JitLink libraries are in your path:
...
Bash
ros2 launch mavros px4.launch fcu_url:=udp://:14540@localhost:14557
ros2 service call /mavros/set_home mavros_msgs/srv/CommandHome "{current_gps: false, latitude: 47.397742, longitude: 8.545594, altitude: 488.0}"
Terminal 3: Navigation Node
